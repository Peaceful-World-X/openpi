...
class LeRobotDataset(torch.utils.data.Dataset):
    ...
    def add_frame(self, frame: dict) -> None:
        ...
        for key in frame:
            ...
            if self.features[key]["dtype"] not in ["image"]:
    ...
    def save_episode(self, task: str, encode_videos: bool = True, episode_data: dict | None = None, mode: str = "video") -> None:
        """
        ...
        if mode == "video": 
            for key in self.meta.video_keys:
                ...
                # write_video(video, video_path,、 self.fps, overwrite=True)
        elif encode_videos and len(self.meta.video_keys) > 0:
