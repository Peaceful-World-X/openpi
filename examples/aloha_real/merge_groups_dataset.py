...
def save_parquet(data_df, save_path):
...
def pad_parquet_data(source_path, target_path, original_dim=14, target_dim=18):
    ...
    # 保存到新的parquet文件
    save_parquet(new_df, target_path)
...
if __name__ == "__main__":
    ...
    # Add arguments
    parser.add_argument("--sources", nargs="+", required=True, help="List of source folder paths contain groups")
    parser.add_argument("--output", required=True, help="Output folder path")
    parser.add_argument("--state_max_dim", type=int, default=14, help="Maximum state vector dimension (default: 14)")
    parser.add_argument("--action_max_dim", type=int, default=14, help="Maximum action vector dimension (default: 14)")
    parser.add_argument("--fps", type=int, default=30, help="Your datasets FPS (default: 30)")
